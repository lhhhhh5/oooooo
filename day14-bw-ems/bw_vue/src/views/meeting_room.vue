...
export default {
    ...
    methods: {
        loadDataList: function() {
            ...
            that.$http('conference_room/selectConferenceRoomByCondition', 'POST', data, true, function(resp) {
                let page = resp.page;
        ...
        deleteHandle: function(id) {
            ...
            if (ids.length == 0) {
                ...
                that.$confirm(`确定要删除选中的记录？`, '提示', {
                    ...
                    that.$http('conference_room/deleteConferenceRoomByIds', 'POST', { ids: ids }, true, function(resp) {
                        if (resp.status > 0) {
                            that.$message({
                                message: '操作成功',
                                type: 'success',
